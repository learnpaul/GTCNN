...
from Gray-CNN import googlenet
from Texture-CNN import googlenett
from datagenerator import ImageDataGenerator
#from datagenerator_texture import ImageDataGenerator_Texture
...
def main():
    ...
    def test_texture():
        ...
        test_data = ImageDataGenerator(
            ...
            shuffle=False)       
        return test_data        
    x1 = tf.placeholder(tf.float32, [train_batch_size, 224, 224, 3])
    y1 = tf.placeholder(tf.float32, [train_batch_size, num_classes])
    print 'x1:'
    print x1.shape
    x2 = tf.placeholder(tf.float32, [train_batch_size, 224, 224, 3])
    print 'x2:'
    print x2.shape    
    ...
    fc8 = googlenet(x1,keep_prob, num_classes)
    fcc8 = googlenett(x2,keep_prob, num_classes)    
